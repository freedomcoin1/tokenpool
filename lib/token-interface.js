...
module.exports =  {
 ...
 async  update()
  ...
  {
    return await this.redisInterface.loadRedisData('miningTarget');
  },
  ...
  async collectTokenParameters( )
  {
    ...
    if (challengeNumber != this.challengeNumber)
      ...
      this.redisInterface.storeRedisData('miningTarget',miningTarget)
      ...
      var storedBlockNumber = await this.getEthBlockNumber();
      if (ethBlockNumber != storedBlockNumber) {
        console.log('New eth block:', ethBlockNumber )
